...
class Ml_animal extends StatefulWidget {
  @override
  _Mlani createState() => _Mlani();
}

class _Mlani extends State<Ml_animal> {
  List _outputs;
  File _image;
  bool _loading = false;
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("images/MLanimal.jpg"),
                    fit: BoxFit.cover,
...
//      ),
  ...
  loadModel() async {
    await Tflite.loadModel(
      model: "assets/model_unquant_animals.tflite",
